...
public class HtmlDocumentExceptionTest extends DocumentFoundationTest {
	...
	public void constractor() {
		...
		HtmlDocumentException sut1 = new HtmlDocumentException(ERROR_FALLED_TO_CREATE_URI_INSTANCE);
		...
		// 指定の埋め込み文字列が取得できること
		// throwクラスは取得できないこと
		HtmlDocumentException sut2 = new HtmlDocumentException(ERROR_FALLED_TO_CREATE_URI_INSTANCE, "http://www.google.com");
		...
		// 埋め込み文字列が取得できないこと
		// throwクラスは取得できること
		HtmlDocumentException sut3 = new HtmlDocumentException(ERROR_FALLED_TO_CREATE_URI_INSTANCE, new NullPointerException());
		...
		// 指定の埋め込み文字列が取得できること
		// throwクラスが取得できること
		HtmlDocumentException sut4 = new HtmlDocumentException(ERROR_FALLED_TO_CREATE_URI_INSTANCE, "http://www.google.com", new NullPointerException());
		...
		HtmlDocumentException sut5 = new HtmlDocumentException(ERROR_FALLED_TO_CREATE_URI_INSTANCE, strList, new NullPointerException());
		...
		HtmlDocumentException sut6 = new HtmlDocumentException(ERROR_FALLED_TO_CREATE_URI_INSTANCE, strArray, new NullPointerException());
