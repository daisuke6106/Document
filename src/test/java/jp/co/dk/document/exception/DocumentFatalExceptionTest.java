...
public class DocumentFatalExceptionTest extends DocumentFoundationTest {
	...
	public void constractor() {
		...
		DocumentFatalException sut1 = new DocumentFatalException(ERROR_FALLED_TO_CREATE_URI_INSTANCE);
		...
		// 指定の埋め込み文字列が取得できること
		// throwクラスは取得できないこと
		DocumentFatalException sut2 = new DocumentFatalException(ERROR_FALLED_TO_CREATE_URI_INSTANCE, "http://www.google.com");
		...
		// 埋め込み文字列が取得できないこと
		// throwクラスは取得できること
		DocumentFatalException sut3 = new DocumentFatalException(ERROR_FALLED_TO_CREATE_URI_INSTANCE, new NullPointerException());
		...
		// 指定の埋め込み文字列が取得できること
		// throwクラスが取得できること
		DocumentFatalException sut4 = new DocumentFatalException(ERROR_FALLED_TO_CREATE_URI_INSTANCE, "http://www.google.com", new NullPointerException());
		...
		DocumentFatalException sut5 = new DocumentFatalException(ERROR_FALLED_TO_CREATE_URI_INSTANCE, strList, new NullPointerException());
		...
		DocumentFatalException sut6 = new DocumentFatalException(ERROR_FALLED_TO_CREATE_URI_INSTANCE, strArray, new NullPointerException());
